class BusinessMailer < ApplicationMailer
  ...
  def developer_profiles
    ...
    subject = "#{pluralize(@developers.count, "new developer profile")} added to Quebec Dev"
  ...
  def new_terms
    @business = params[:business]
    from = Rails.configuration.emails.support_mailbox!
    subject = "Updated Quebec Dev terms of use and hiring agreement"
  ...
  def survey
    @business = params[:business]
    from = Rails.configuration.emails.support_mailbox!
    subject = "Why do you use Quebec Dev to hire? 1 question survey + swag"
